...
svm_model = SVC(kernel="linear", C=0.5)  # Linear kernel works well for text data
...
scores = cross_val_score(svm_model, X_train_tfidf, y_train, cv=5)  # 5-fold cross-validation
